    ...
    <article className="card-glass overflow-hidden rounded-3xl">
      ...
      <div className="space-y-4 p-5">
        <div>
          ...
          <h3 className="mt-2 text-xl font-black leading-tight">{item.model}</h3>
        ...
        <div className="flex gap-2">
          <button className="flex-1 rounded-2xl bg-volt py-3 font-black text-black">Buy Now</button>
          <button className="rounded-2xl border border-white/15 px-4"><Shuffle size={18} /></button>
          <button className="rounded-2xl border border-white/15 px-4"><ShieldCheck size={18} /></button>
        </div>
      </div>
    </article>
  );
